###########################################################################
## Makefile generated for Simulink model 'arduino_I2C_hmc5983'. 
## 
## Makefile     : arduino_I2C_hmc5983.mk
## Generated on : Thu Oct 24 22:40:28 2019
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_I2C_hmc5983.elf
...
PRODUCT_NAME              = arduino_I2C_hmc5983
MAKEFILE                  = arduino_I2C_hmc5983.mk
MATLAB_ROOT               = Z:/Program Files/MATLAB/R2019b
MATLAB_BIN                = Z:/Program Files/MATLAB/R2019b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = Z:/Documents/MATLAB
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_I2C_hmc5983.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/shared/svd/include -I$(START_DIR)/arduino_I2C_hmc5983_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/3P778C~1.INS/ARDUIN~1.INS/hardware/arduino/avr/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/3P778C~1.INS/ARDUIN~1.INS/hardware/arduino/avr/LIBRAR~1/Wire/src/utility
...
DEFINES_STANDARD = -DMODEL=arduino_I2C_hmc5983 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/arduino_I2C_hmc5983.c $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/arduino_I2C_hmc5983_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_pulse.S" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/hooks.c" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WInterrupts.c" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring.c" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_analog.c" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_digital.c" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_pulse.c" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_shift.c" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/abi.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/CDC.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial0.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial1.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial2.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial3.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/PluggableUSB.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/IPAddress.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/new.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Print.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Stream.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Tone.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/USBCore.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WMath.cpp" "$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WString.cpp" C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c C:/ProgramData/MATLAB/SupportPackages/R2019b/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src/Wire.cpp C:/ProgramData/MATLAB/SupportPackages/R2019b/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src/utility/twi.c

MAIN_SRC = $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/ert_main.c
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_arduinoI2C.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduino_I2C_hmc5983.o : $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/arduino_I2C_hmc5983.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_I2C_hmc5983_data.o : $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/arduino_I2C_hmc5983_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_I2C_hmc5983_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
MW_ArduinoHWInit.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


io_wrappers.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduinoAVRScheduler.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ext_svr_daemon.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtiostream_serial_daemon.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


daemon_checksum.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Wire.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src/Wire.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


twi.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src/utility/twi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
